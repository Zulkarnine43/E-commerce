                                ...
                                <div class="bootstrap-tab-text-grids">
                                    ...
                                    <div>
                                        ...
                                        @foreach($messages as $message)
                                            ...
                                            <div>
                                                <span class=" float-right col-md-offset-6" style="color: black"><a  href="{{route('confirm_reply',['id'=>$crop->id,'product_name'=>$crop->product_name,'farmer_email'=>$farmer->email])}}">Reply</a></span>
                                            </div>
                                        @endforeach
                                    </div>
