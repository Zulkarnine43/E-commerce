...
<div class="header-bot">
    <div class="container">
        ...
        <div class="col-md-3 header-right footer-bottom">
            <ul>
                <div class="card">
                    <img src="{{url('public/front/images/profile.png')}}" alt="image" style="width:40%" height="100" >
                    <h1>{{Session::get('cust_name')}}</h1>
                    <p class="title">{{Session::get('cust_district')}}</p>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            <li class=" menu__item"><a class="menu__link" href="{{route('customer_home_page')}}">Home</a></li>
                            <li class=" menu__item"><a class="menu__link" href="{{route('collection_info')}}">Collection_Info</a></li>
                            <li class=" menu__item"><a class="menu__link" href="{{route('farmer_info')}}">Farmer_Info</a></li>
                            <li class=" menu__item"><a class="menu__link" href="{{route('cust_notification')}}">Notification</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
