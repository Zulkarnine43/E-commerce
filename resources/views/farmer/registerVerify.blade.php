 ...
 @extends('home.headerFooter')
   @section('body')
       <div class="login" style="margin-top: 100px; margin-bottom: 100px">
                   <h3  class="col-md-offset-4 col-md-3 text-center text-success" style="background-color: limegreen">Login If you already register</h3>
        </div>

                <form action="{{route('farmer_login_check')}}" method="POST">
                    @csrf
...
<div class="form-group col-md-offset-5 col-md-4">
   ...
   <a href="{{route('farmer_register')}}" class="forg-right">Register</a>
        </div>
