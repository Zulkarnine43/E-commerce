...
<div class="header-bot">
    <div class="container">
        ...
        <div class="col-md-3 header-right footer-bottom">
            <ul>
                <h1><a href="{{route('cart_details')}}"><img src="{{url('public/front/images/cart.png')}}" height="55" width="55"></a></h1>
                <li><a href="#" class="use1 success" data-toggle="modal" data-target="#myModal4"><span >Login</span></a>
                </li>
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            <li class="dropdown menu__item">
                                <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Farmers <span class="caret"></span></a>
                                <ul class="dropdown-menu multi-column columns-2" style="background-color: black">
                                    <div class="row">
                                        <div class="col-sm-3 multi-gd-img">
                                            <ul class="multi-column-dropdown"  style="font-weight: bold ;color: white ;margin-left: 70px" >
                                                <li><a href="{{route('farmer_register')}}">Register</a></li>
                                                <li><a href="{{route('farmer_login')}}">login</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </ul>
                            ...
                            <li class="dropdown menu__item">
                                <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Customer <span class="caret"></span></a>
                                <ul class="dropdown-menu multi-column columns-2" style="background-color: black">
                                    <div class="row">
                                        <div class="col-sm-3 multi-gd-img">
                                            <ul class="multi-column-dropdown" style="font-weight: bold ;color: white ;margin-left: 70px">
                            ...
                            <li class=" menu__item"><a class="menu__link" href="{{route('gallary')}}">gallary</a></li>
                            <li class=" menu__item"><a class="menu__link" href="{{route('about_us')}}">About Us</a></li>
                            <li class=" menu__item"><a class="menu__link" href="{{route('contact_us')}}">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
...
<div class="footer">
    <div class="container">
        <div class="col-md-3 footer-left">
            <h2><a href="{{route('index')}}"><img src="{{url('public/front/images/greenLife.jpg')}}" alt=" " /></a></h2>
            <p>কৃষিকার্য বা কৃষি মানবজাতির আদিমতম পেশা হিসেবে চিহ্নিত। মানুষের জীবনধারনের জন্য শষ্য উৎপাদন কিংবা গৃহপালিত পশু রক্ষণাবেক্ষনের জন্যে যথোচিত খাদ্য এবং প্রয়োজনীয় কাঁচামাল উৎপাদন ও সরবরাহসহ বহুবিধ উদ্দশ্যে প্রতিপালনের লক্ষ্যে কৃষিকার্য নির্বাহ করা হয়। যিনি কৃষির সাথে সংশ্লিষ্ট তিনিই কৃষক। </p>
        </div>
        <div class="col-md-9 footer-right">
            ...
            <div class="sign-grds">
                ...
                <div class="col-md-5 sign-gd-two">
                    ...
                    <ul>
                        <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Address : kazi Nazrul Islam Avenue, 4th block, <span>Dhaka City.</span></li>
        ...
        <div class="clearfix"></div>
        <p class="copy-right">&copy 2019 Green Life. All rights reserved | Developer by <a href="">Zulkar Nine (Shaon)</a></p>
    </div>
</div>
</body>
</html>
